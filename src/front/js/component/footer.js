          ...
          <div className="col-md">
            <div className="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul className="list-unstyled">
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Neurología</a></li>
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Oftalmología</a></li>
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Nuclear</a></li>
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Quirúrgico</a></li>
                <li><a href="#"><span className="icon-long-arrow-right mr-2"></span>Cardiología</a></li>
